...
public class SubwayView {
	...
	///////////////////////////////////////////////////////////////
	public void menu() {
		System.out.println("[교통카드 충전금액을 입력하세요 : ] : ");
	...
	public void printSuccess(CardDTO card, StationDTO start, StationDTO end, int chargedFee) {
		...
		System.out.println("승차역은"+start.getName()+"역이고, 하차역은"+end.getName()+"역 입니다.");
	 ...
	 * document comment
	 * 역선택 메서드 
	 * @param stations 역정보를 담ㄷ는 배열 
	 * @param msg 	   출력메시지
	 */
	public int selectNumber(StationDTO [] stations , String msg) {
		System.out.println(msg+"역을 선택하세요. 1~"+stations.length + ":" );
